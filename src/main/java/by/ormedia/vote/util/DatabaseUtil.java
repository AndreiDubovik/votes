...
public class DatabaseUtil {
	...
	private static final String URL = "jdbc:h2:file:~/h2/votedb;DB_CLOSE_ON_EXIT=TRUE";
	...
	public static Configuration getConfiguration() {
		Configuration configuration = new Configuration().setProperty("hibernate.connection.driver_class", DRIVER_CLASS)
				...
				.addAnnotatedClass(by.ormedia.vote.entity.Item.class)
				.addAnnotatedClass(by.ormedia.vote.entity.Subject.class)
				.addAnnotatedClass(by.ormedia.vote.entity.VoteTicket.class)
				.addAnnotatedClass(by.ormedia.vote.entity.User.class);
